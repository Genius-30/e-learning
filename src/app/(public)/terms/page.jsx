    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <section className="mb-6">
        ...
        <p className="mt-2 text-text/60">
          ...
          materials for personal, non-commercial use only. This is the grant of
      ...
      <section className="mb-6">
        ...
        <p className="mt-2 text-text/60">
          The materials on this site are provided "as is". We make no
      ...
      <section className="mb-6">
        ...
        <p className="mt-2 text-text/60">
          In no event shall [Your Company Name] be liable for any damages
